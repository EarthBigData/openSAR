...
If you don't have the code management software **git** installed on your system, you should download and install it from this location: [https://git-scm.com/downloads](https://git-scm.com/downloads). Using **git** and **Github**, you can easily "clone" code repositories to your local computer. Cloning from Github has the benefit that any updates to a software repository is easily updated later with the *git pull* command. Or you can contribute to improve the open source software by pushing your modifications back to github with *git push*. To install git on or system go to  [https://git-scm.com/downloads](https://git-scm.com/downloads). 
